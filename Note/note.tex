...
\label{sec:monte_carlo_simulation}
    ...
    \label{sub:simulation_with_sherpa}
        ...
        \begin{lstlisting}
            ...
            PARTICLE_DATA:
              24: {Width: 0, Narrow: 1}   # W Boson
              23: {Width: 0, Narrow: 1}   # Z Boson
            WIDTH_SCHEME: Fixed
            ...
            HARD_DECAYS:
              Enabled: true
              Channels:
                24,-11,12: {Status: 2}   # W+ -> e+ nu_e
                24,-13,14: {Status: 2}   # W+ -> mu+ nu_mu
              Pol_Cross_Section:
                Enabled: true
        ...
        Table~\ref{tab:sherpa_WpWm_cross_section} details the absolute cross-sections for the individual $W^{+}W^{+}jj$ and $W^{-}W^{-}jj$ samples at various selection stages, with the polarization states defined in the $W^{\pm}W^{\pm}$ center-of-mass frame. The overall selection efficiency into the signal region is roughly 1\%. This low efficiency suggests that the generation-level kinematic cuts could be further optimized to improve the event generation yield.
    \begin{table}[htpb]
        \centering
        ...
        \begin{tabular}{l|rrrr|rrrr}
            ...
            Total      & 13.242 & 41.452 & 73.953 & 128.647 & 3.716 & 10.970 & 19.530 & 34.216 \\
            Lepton cut & 0.214  & 0.529  & 1.137  & 1.880   & 0.070 & 0.191  & 0.377  & 0.639  \\
            MET cut    & 0.161  & 0.480  & 1.037  & 1.678   & 0.058 & 0.166  & 0.337  & 0.561  \\
            Jet cut    & 0.153  & 0.424  & 0.844  & 1.421   & 0.042 & 0.121  & 0.276  & 0.439  \\ 
        \end{tabular}
    \end{table}

    The combined absolute cross-sections for the EW $W^{\pm}W^{\pm}jj$ production are summarized in Table~\ref{tab:sherpa_WWjj_cross_section}. While the relative fractions of the polarization states remain in excellent agreement with the thesis, the combined absolute cross-section is still lower than the reference values.
    \begin{table}[htpb]
        \centering
        ...
        \begin{tabular}{l|rrrr}
            Cut               & LL [fb] & LT [fb] & TT [fb] & Total [fb] \\ \hline
            Total             & 16.958  & 52.422  & 93.483  & 162.863    \\
            Lepton cut        & 0.284   & 0.721   & 1.514   & 2.519      \\
            MET cut           & 0.220   & 0.646   & 1.374   & 2.240      \\
            Jet cut           & 0.195   & 0.545   & 1.121   & 1.860      \\ \hline
            Jet cut (Thesis)  & 0.285   & 0.909   & 1.778   & 2.933      \\ \hline
            Fraction          & 10.4\%  & 29.3\%  & 60.3\%  & 100\%      \\
