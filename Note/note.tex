...
\label{sec:monte_carlo_simulation}
    ...
    \label{sub:particle_level_selection}
        ...
        Specifically, the variables and object collections accessed in our \verb|Delphes| analysis script were updated as follows:
        \begin{itemize}
        ...
        The updated absolute cross-sections for the EW $W^{\pm}W^{\pm}jj$ production at the particle level are summarized in table~\ref{tab:madgraph_WWjj_cross_section_particle_level} for \verb|MadGraph| and table~\ref{tab:sherpa_WWjj_cross_section_particle_level} for \verb|Sherpa|. The relative fractions of the polarization states remain in excellent agreement with the reference thesis. However, a systematic normalization discrepancy still exists in the absolute cross-sections, suggesting that further review of the fundamental generation parameters may be required. 

        \begin{table}[htpb]
            \centering
            \caption{Combined absolute cross-sections for the EW $W^{\pm}W^{\pm}jj$ production simulated with \texttt{MadGraph} using \textbf{particle-level selection}. Reference values from the previous thesis and relative fractions are provided at the final jet cut stage for comparison.}
            \label{tab:madgraph_WWjj_cross_section_particle_level}
            \begin{tabular}{l|rrrr}
                \hline
                Cut               & LL [fb] & LT [fb] & TT [fb] & Total [fb] \\ \hline
                Total             & 0.360   & 1.127   & 2.079   & 3.567      \\
                Lepton cut        & 0.310   & 0.978   & 1.852   & 3.139      \\
                MET cut           & 0.302   & 0.960   & 1.821   & 3.082      \\
                Jet cut           & 0.212   & 0.654   & 1.127   & 1.993      \\ \hline
                Jet cut (Thesis)  & 0.277   & 0.874   & 1.744   & 2.895      \\ \hline
                Fraction          & 10.7\%  & 32.8\%  & 56.6\%  & 100\%      \\
                Fraction (Thesis) & 9.6\%   & 30.2\%  & 60.2\%  & 100\%      \\ \hline
            \end{tabular}
        \end{table}

        \begin{table}[htpb]
            \centering
            \caption{Combined absolute cross-sections for the EW $W^{\pm}W^{\pm}jj$ production simulated with \texttt{Sherpa} using \textbf{particle-level selection}. Reference values from the previous thesis and relative fractions are provided at the final jet cut stage for comparison.}
            \label{tab:sherpa_WWjj_cross_section_particle_level}
            \begin{tabular}{l|rrrr}
                \hline
                Cut               & LL [fb] & LT [fb] & TT [fb] & Total [fb] \\ \hline
                Total             & 0.727   & 2.205   & 3.882   & 6.814      \\
                Lepton cut        & 0.339   & 1.031   & 1.928   & 3.298      \\
                MET cut           & 0.279   & 0.895   & 1.679   & 2.853      \\
                Jet cut           & 0.193   & 0.581   & 0.995   & 1.769      \\ \hline
                Jet cut (Thesis)  & 0.285   & 0.909   & 1.778   & 2.933      \\ \hline
                Fraction          & 10.9\%  & 32.9\%  & 56.3\%  & 100\%      \\
                Fraction (Thesis) & 9.6\%   & 30.6\%  & 59.8\%  & 100\%      \\ \hline
            \end{tabular}
        \end{table}
